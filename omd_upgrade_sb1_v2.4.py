...
#key_name_component = ('salt', 'director','core','monitor','monitor-plugin', 'insight')
key_name_component = ('salt', 'director','core','monitor','insights')
#key_name_monitor_component = ('monitor-','monitor-plugin')
    ...
    while True:
        ...
        if isinstance(send_key, list):
            for i in send_key:
                ...
                # to be implemented a control based on system process and proceed upgrade and pass_send_key
...
def apply_high_state(pass_send_key = None):
    while True:
        ...
        if key_name_component[0] in send_key: #salt
            ...
            print txt_execute[:6] + txt_ing + 3 * a_dot + a_space + key_name_component[1] + a_space + txt_install
            ...
            print txt_execute[:6] + txt_ing + 3 * a_dot + a_space + key_name_component[2] + a_space + txt_install
            ...
            print txt_execute[:6] + txt_ing + 3 * a_dot + a_space + key_name_component[3] + a_space + txt_install
            ...
            print txt_execute[:6] + txt_ing + 3 * a_dot + a_space + key_name_component[4] + a_space + txt_install
